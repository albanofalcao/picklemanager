...
const App = {
  ...
  SEED_TURMAS: [
    ...
    { nome: 'Turma Iniciante Tarde',       tipo: 'grupo',      nivel: 'iniciante',     professorId: '', professorNome: 'Beatriz Tavares', arenaId: '', arenaNome: 'Arena Central', diasSemana: ['ter','qui'],       horarioInicio: '14:00', horarioFim: '15:00', vagas: 8,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Iniciante Noite',       tipo: 'grupo',      nivel: 'iniciante',     professorId: '', professorNome: 'Viviane Correia', arenaId: '', arenaNome: 'Arena Central', diasSemana: ['seg','qua'],       horarioInicio: '20:00', horarioFim: '21:00', vagas: 8,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Intermediário Manhã',   tipo: 'grupo',      nivel: 'intermediario', professorId: '', professorNome: 'Fernanda Lima',   arenaId: '', arenaNome: 'Arena Norte',   diasSemana: ['seg','qua','sex'], horarioInicio: '09:30', horarioFim: '10:30', vagas: 6,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Intermediário Noite',   tipo: 'grupo',      nivel: 'intermediario', professorId: '', professorNome: 'Isabela Campos',  arenaId: '', arenaNome: 'Arena Norte',   diasSemana: ['ter','qui'],       horarioInicio: '19:00', horarioFim: '20:00', vagas: 6,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Avançado Manhã',        tipo: 'grupo',      nivel: 'avancado',      professorId: '', professorNome: 'Ricardo Alves',   arenaId: '', arenaNome: 'Arena VIP',     diasSemana: ['seg','qua'],       horarioInicio: '07:00', horarioFim: '08:30', vagas: 4,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Avançado Tarde',        tipo: 'grupo',      nivel: 'avancado',      professorId: '', professorNome: 'Marcos Vieira',   arenaId: '', arenaNome: 'Arena Norte',   diasSemana: ['ter','qui'],       horarioInicio: '16:00', horarioFim: '17:30', vagas: 4,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Juvenil',               tipo: 'grupo',      nivel: 'iniciante',     professorId: '', professorNome: 'Paulo Henrique',  arenaId: '', arenaNome: 'Arena Central', diasSemana: ['sab'],             horarioInicio: '09:00', horarioFim: '10:00', vagas: 10, status: 'ativa',    observacoes: 'Para alunos até 18 anos.' },
    { nome: 'Turma Sênior 60+',            tipo: 'grupo',      nivel: 'iniciante',     professorId: '', professorNome: 'Priscila Mendes', arenaId: '', arenaNome: 'Arena Central', diasSemana: ['ter','qui'],       horarioInicio: '10:00', horarioFim: '11:00', vagas: 8,  status: 'ativa',    observacoes: 'Turma exclusiva 60+.' },
    { nome: 'Turma Feminina',              tipo: 'grupo',      nivel: 'intermediario', professorId: '', professorNome: 'Larissa Pinto',   arenaId: '', arenaNome: 'Arena Norte',   diasSemana: ['qua','sex'],       horarioInicio: '18:00', horarioFim: '19:00', vagas: 6,  status: 'ativa',    observacoes: '' },
    { nome: 'Treino de Competição',        tipo: 'grupo',      nivel: 'profissional',  professorId: '', professorNome: 'Rodrigo Fonseca', arenaId: '', arenaNome: 'Arena VIP',     diasSemana: ['seg','ter','qua','qui','sex'], horarioInicio: '07:00', horarioFim: '09:00', vagas: 6, status: 'ativa', observacoes: 'Exclusivo para competidores.' },
    { nome: 'Turma Duplas Mistas',         tipo: 'dupla',      nivel: 'intermediario', professorId: '', professorNome: 'Carlos Nunes',    arenaId: '', arenaNome: 'Arena Norte',   diasSemana: ['sab'],             horarioInicio: '10:00', horarioFim: '12:00', vagas: 8,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Open Sábado',           tipo: 'grupo',      nivel: 'aberto',        professorId: '', professorNome: 'Gabriel Santos',  arenaId: '', arenaNome: 'Arena Central', diasSemana: ['sab'],             horarioInicio: '14:00', horarioFim: '16:00', vagas: 12, status: 'ativa',    observacoes: 'Todos os níveis, formato de jogos.' },
    { nome: 'Turma Reabilitação',          tipo: 'grupo',      nivel: 'iniciante',     professorId: '', professorNome: 'Anderson Costa',  arenaId: '', arenaNome: 'Arena Central', diasSemana: ['seg','qua'],       horarioInicio: '11:00', horarioFim: '12:00', vagas: 4,  status: 'ativa',    observacoes: 'Com acompanhamento fisioterapêutico.' },
    { nome: 'Clínica Individual',          tipo: 'individual', nivel: 'avancado',      professorId: '', professorNome: 'Ricardo Alves',   arenaId: '', arenaNome: 'Arena VIP',     diasSemana: ['sex'],             horarioInicio: '09:00', horarioFim: '10:00', vagas: 1,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma VIP Individual',        tipo: 'individual', nivel: 'avancado',      professorId: '', professorNome: 'Felipe Moraes',   arenaId: '', arenaNome: 'Arena VIP',     diasSemana: ['seg','qua','sex'], horarioInicio: '17:00', horarioFim: '18:00', vagas: 1,  status: 'ativa',    observacoes: '' },
    { nome: 'Turma Meia Temporada',        tipo: 'grupo',      nivel: 'intermediario', professorId: '', professorNome: 'Natalia Ramos',   arenaId: '', arenaNome: 'Arena Norte',   diasSemana: ['ter','qui'],       horarioInicio: '15:00', horarioFim: '16:00', vagas: 6,  status: 'suspensa', observacoes: 'Aguardando retorno da professora.' },
  ],
